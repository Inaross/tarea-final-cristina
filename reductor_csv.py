...
def reducir_csv_por_tamano(ruta_origen, ruta_destino, tamano_max_mb=2):
...
if __name__ == "__main__":
    ...
    archivo_salida = 'D:\\Big Data Aplicado\\Optimizacion\\Codigo\\matchups2mb.csv'
    
    reducir_csv_por_tamano(archivo_entrada, archivo_salida, tamano_max_mb=2)