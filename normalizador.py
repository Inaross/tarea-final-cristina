...
print("\nGenerando archivos relacionales para MySQL...")
...
print("\nGenerando documento estructurado para MongoDB (Modo Rápido)...")
...
print(f"  Tiempo de generación JSON: {fin_json - inicio_json:.2f} segundos")
